...
const Landing = () => {
  ...
  return (
   <div className='bg-white'>
    ...
    >
      <div className='text-white m-auto text-4xl sm:text-6xl font-bold text-center'>
        <div className='mb-8'>Partner with us to grow your travel business</div>
        <a href='/register' className='text-xl bg-blue-600 hover:bg-blue-900 py-4 px-8 rounded-full'>Get Started</a>   
      </div>
    </section>
    <div className='grid sm:grid-cols-3 grid-cols-1 items-center gap-4 px-4 py-8 sm:px-12 md:px-24'>
